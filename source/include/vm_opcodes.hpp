...
typedef enum {
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
  // TODO - Are these any use in reality?
  ...
  // Vector arithmetic shift left
  //
  // vd[i] = va[i] << vb[i]

  _VASL_8,   _VASL_16,   _VASL_32,   _VASL_64, // op_vec_vasl_impl.hpp
  ...
  _VASR_8,   _VASR_16,   _VASR_32,   _VASR_64, // op_vec_vasr_impl.hpp
