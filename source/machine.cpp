...
using namespace ExVM;
  ...
  #include "include/platforms/machine_amigaos_68k_impl.hpp"
#elif (_VM_HOST_OS == _VM_HOST_AMIGAOS3_WARPUP)
  #include "include/platforms/machine_amigaos_wos_impl.hpp"
#elif (_VM_HOST_OS == _VM_HOST_AMIGAOS4_PPC)
  #include "include/platforms/machine_amigaos_os4_impl.hpp"
#endif
